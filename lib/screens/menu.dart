...
class MyHomePage extends StatelessWidget {
  ...
  final List<ItemHomepage> items = [
    ItemHomepage(
        "Lihat Daftar Produk", Icons.view_list, Colors.green), // Example color
    ItemHomepage("Tambah Product", Icons.add, Colors.blue), // Example color
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Malaccan" dengan teks putih dan tebal.
        title: const Text(
          'Malaccan',
          style: TextStyle(
            color: Colors.white,
